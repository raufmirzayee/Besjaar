(() => {
  ...
  function initGallery(root) {
    ...
    const stage = root.querySelector('.nova-product-v16__media-stage');
    ...
    const measure = (method, index = activeIndex) => {
      ...
      document.dispatchEvent(new CustomEvent('nova:measurement', { detail: { name: 'product_gallery_interacted', detail: { method, mediaIndex: index + 1, mediaCount: slides.length } } }));
    };
