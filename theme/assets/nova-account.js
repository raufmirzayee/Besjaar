/* Besjaar Nova 5.0 Phase 1 — customer account runtime */
// Nova 4.6 — Retail Account OS
(() => {
  ...
  const localeRoot=String(window.NovaConfig?.routes?.root||window.Shopify?.routes?.root||'/');
  ...
  const routes=(window.NovaConfig&&window.NovaConfig.routes)||{};
